...
import { ARBITRUM_LIST, CELO_LIST, MAISTESTSUBNET_LIST, OPTIMISM_LIST } from './lists'
...
const CHAIN_INFO: ChainInfoMap = {
  ...
  [SupportedChainId.MAISTESTSUBNET]: {
    networkType: NetworkType.L1,
    docs: 'https://docs.uniswap.org/',
    explorer: 'http://174.138.9.169:3006/',
    infoLink: '',
    label: 'Maistestsubnet',
    logoUrl: ethereumLogoUrl,
    nativeCurrency: { name: 'Mai', symbol: 'MAI', decimals: 18 },
    color: colorsDark.chain_3,
    defaultListUrl: MAISTESTSUBNET_LIST,
  },
}
