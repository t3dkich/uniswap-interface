...
export const DAI_MAISTESTSUBNET = new Token(
  SupportedChainId.MAISTESTSUBNET,
  '0x3475a2a272F7C73c85E000AA7ecD82595367bef9',
  18,
  'DAI',
  'Dai stable coin'
)
export const USDC: { [chainId in SupportedChainId]: Token } = {
  ...
  [SupportedChainId.MAISTESTSUBNET]: DAI_MAISTESTSUBNET,
}
...
export const WRAPPED_NATIVE_CURRENCY: { [chainId: number]: Token | undefined } = {
  ...
  [SupportedChainId.MAISTESTSUBNET]: new Token(
    SupportedChainId.MAISTESTSUBNET,
